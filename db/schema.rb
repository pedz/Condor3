...
ActiveRecord::Schema.define(:version => 47) do
  ...
  add_index "adv_ptf_release_maps", ["apar_defect_version_map_id", "ptf_id", "release_id"], :name => "adv_ptf_release_maps_apar_defect_version_map_id_ptf_id_rele_key", :unique => true
  ...
  add_index "aix_files", ["path", "sha1"], :name => "aix_files_path_sha1_key", :unique => true
  ...
  add_index "apar_defect_version_maps", ["apar_id", "defect_id", "version_id"], :name => "apar_defect_version_maps_apar_id_defect_id_version_id_key", :unique => true
  ...
  add_index "fileset_aix_file_maps", ["fileset_id", "aix_file_id"], :name => "fileset_aix_file_maps_fileset_id_aix_file_id_key", :unique => true
  ...
  add_index "fileset_ptf_maps", ["fileset_id", "ptf_id"], :name => "fileset_ptf_maps_fileset_id_ptf_id_key", :unique => true
  ...
  add_index "filesets", ["lpp_id", "vrmf"], :name => "filesets_lpp_id_vrmf_key", :unique => true
  ...
  add_index "lpps", ["name", "lpp_base_id"], :name => "lpps_name_lpp_base_id_key", :unique => true
  ...
  add_index "package_fileset_maps", ["package_id", "fileset_id"], :name => "package_fileset_maps_package_id_fileset_id_key", :unique => true
  ...
  add_index "packages", ["name", "sha1"], :name => "packages_name_sha1_key", :unique => true
  ...
  add_index "releases", ["name", "family_id"], :name => "releases_name_family_id_key", :unique => true
  ...
  add_index "service_pack_fileset_maps", ["service_pack_id", "fileset_id"], :name => "service_pack_fileset_maps_service_pack_id_fileset_id_key", :unique => true
  ...
  add_index "upd_pc_views", ["update_id", "pc_id"], :name => "upd_pc_views_update_id_pc_id_key", :unique => true
